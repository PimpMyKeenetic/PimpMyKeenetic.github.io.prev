...
```
<p class="message">
Обратите внимание, что rci-интерфейс на порту TCP79 отвечает только для localhost'а. По адресу http://my.keenetic.net/rci интерфейс отвечает на запросы с любого адреса, но требует digest-авторизацию. Именно его использует веб-интерфейс прошивки для взаимодействия с ядром.
</p>  
